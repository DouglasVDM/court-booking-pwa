...
const BookingsList = ({ bookings, setBookings, loading, error, apiEndpointPrefix }) => {
  const { deleteBooking, loading: deleting, error: deleteError } = useDeleteBooking(apiEndpointPrefix);
